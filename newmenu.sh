...
Exp=$(curl -sS https://raw.githubusercontent.com/vlastech2022vpn/access/main/ip | grep $MYIP | awk '{print $3}')
fi
chck_b(){
...
curl -sS https://raw.githubusercontent.com/vlastech2022vpn/vpn/main/clgshow
echo -e "
"
fi
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
